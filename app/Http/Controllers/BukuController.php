...
class BukuController extends Controller
{
    public function store(Request $req)
    {
        ...
        if($simpan){
            ...
            return Response()->json(['status'=> 'Data buku gagal dimasukkan']);
        }
    }
}
    ...
    public function update($id, Request $req)
    {
        ...
        if($ubah){
            return Response()->json(['status'=> 'Data buku berhasil diubah']);
        } else {
            return Response()->json(['status'=> 'Data buku berhasil diubah']);
        }
    }
    ...
    public function hapus($id){
        ...
        if($hapus){
            return Response()->json(['status'=> 'Data buku berhasil dihapus']);
        } else {
            return Response()->json(['status'=> 'Data buku gagal dihapus']);
        }
    }
}
