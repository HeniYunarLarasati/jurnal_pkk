...
class TransaksiController extends Controller
{
    ...
    public function store(Request $req)
    {
        ...
        if($simpan){
            ...
            return Response()->json(['status'=> 'Data transaksi gagal ditambahkan']);
        }
    }
    }
    ...
    public function update($id, Request $req)
    {
        ...
        if($ubah){
            return Response()->json(['status'=> 'Data transaksi berhasil diubah']);
        } else {
            return Response()->json(['status'=> 'Data transaksi gagal diubah']);
        }
    }
    }
    public function hapus($id){
        ...
        if($hapus){
            return Response()->json(['status'=> 'Data transaksi berhasil dihapus']);
        } else {
            return Response()->json(['status'=> 'Data transaksi gagal dihapus']);
        }
    }
}
...
public function simpan(Request $req)
    {
        ...
        if($simpan){
            ...
            return Response()->json(['status'=> 'Data detail gagal dimasukkan']);
        }
    }
    }
    ...
    public function ubah($id, Request $req)
    {
        ...
        if($ubah){
            return Response()->json(['status'=> 'Data detail berhasil diubah']);
        } else {
            return Response()->json(['status'=> 'Data detail gagal diubah']);
        }
    }
    }
    public function destroy($id){
        ...
        if($hapus){
            return Response()->json(['status'=> 'Data detail berhasil dihapus']);
        } else {
            return Response()->json(['status'=> 'Data detail gagal dihapus']);
        }
    }
}
